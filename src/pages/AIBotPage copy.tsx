...
const AIBotPage: React.FC<AIBotPageProps> = ({ 
  ...
  const sendInitialGreeting = async () => {
    const greeting = `Hi, I'm D.A.I.V.E.! ${vehicleInfo ? `This ${vehicleInfo.year} ${vehicleInfo.make} ${vehicleInfo.model} is a great choice.` : 'I can help you find the perfect vehicle.'} What would you like to know?`;
          ...
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2">
              ...
              <Badge variant="secondary" className="ml-auto">
                {vehicleInfo ? `${vehicleInfo.year} ${vehicleInfo.make} ${vehicleInfo.model}` : 'Voice Enabled'}
              </Badge>
            </CardTitle>
          </CardHeader>
