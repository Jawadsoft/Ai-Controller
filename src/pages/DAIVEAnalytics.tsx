...
import { Brain, BarChart3, MessageSquare, Users } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">D.A.I.V.E. Analytics</h1>
              <p className="text-gray-600">AI-powered conversation insights and lead generation metrics</p>
            </div>
          </div>
        </div>
