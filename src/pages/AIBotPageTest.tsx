...
const AIBotPageTest: React.FC<AIBotPageProps> = ({ 
  ...
  const VehicleCard: React.FC<{ 
    ...
    return (
      <div 
        className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow cursor-pointer hover:border-primary/25"
        ...
        <div className="mt-3 pt-3 border-t border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center justify-center w-9 h-9 rounded-md bg-primary text-white hover:bg-primary/90 transition-colors"
              onClick={(e) => {
                e.stopPropagation();
                onSelect(vehicle);
              }}
                  ...
                  {listItems.map((item, itemIndex) => {
                    ...
                    if (match) {
                      ...
                      if (itemContent.includes('<button class="view-images-btn"')) {
                        ...
                        return (
                          <div key={itemIndex} className="flex items-start gap-3 p-2 bg-primary/10 rounded-lg border border-primary/15">
            ...
            if (trimmedParagraph.includes('•') || trimmedParagraph.includes('-')) {
             ...
             if (trimmedParagraph.includes('🚗') || trimmedParagraph.includes('**') || trimmedParagraph.includes('💰')) {
               ...
               return (
                 <div 
                   key={index} 
                   className="text-sm leading-relaxed p-3 bg-gradient-to-r from-muted to-muted rounded-lg border border-primary/15"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-muted to-muted p-2 sm:p-4">
                  ...
                  >
                    ...
                    >
                      ...
                      {message.role === 'assistant' && shouldPlayGreetingOnInteraction && index === 0 && (
                        <div className="mt-2 text-xs text-primary bg-primary/10 px-2 py-1 rounded-md border border-primary/20">
                                  ...
                                  if (startPage > 0) {
                                    pages.push(
                                      <button
                                        key={0}
                                        onClick={() => goToPage(0)}
                                        className="w-8 h-8 rounded-full text-sm font-medium transition-colors text-gray-500 hover:text-primary hover:bg-primary/10"
                                      >
                                        1
                                      </button>
                                    );
            ...
            {messages.length <= 1 && (
              <div className="p-6 sm:p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto mb-6">
                  ...
                  {/* Text Input Card */}
                  <div 
                    className="bg-gradient-to-br from-primary/5 to-muted rounded-3xl p-6 border border-primary/20 hover:shadow-lg transition-all duration-300 cursor-pointer hover:scale-105"
                    onClick={() => {
              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
                ...
                <div className="flex gap-1 sm:gap-2 justify-center sm:justify-start">
                  ...
                  <Button
                    ...
                    className={isVADEnabled ? 'bg-primary/10 border-primary/20 text-primary' : 'text-gray-600 border-gray-200'}
                  >
                    🎯
                  </Button>
                  {!isProductionMode && (
                  ...
                  */}
                  ...
                  <Button
                    ...
                    className={`relative w-10 h-10 rounded-full transition-all duration-150 ease-in-out select-none ${
                      isPlaying 
                        ? 'bg-primary border-primary text-white hover:bg-primary shadow-lg' 
                    ...
                    <CardContent className="pt-0">
                      <div className="space-y-3">
                        <div>
                          ...
                          <div className="text-xs bg-primary/10 p-2 rounded mt-1">
      ...
      {isRecording && !isContinuousVoiceMode && (
        <div className="fixed inset-0 z-50 bg-gradient-to-br from-purple-500/95 to-primary/90/95 flex flex-col items-center justify-center backdrop-blur-sm">
          <button 
            onClick={() => {
              stopRecording();
            }}
          ...
          <div className="relative w-64 h-64 mb-8">
            ...
            <div className="absolute inset-8 rounded-full bg-gradient-to-br from-primary/70 to-purple-500 opacity-70" style={{animation: 'ping 1.5s cubic-bezier(0, 0, 0.2, 1) infinite'}}></div>
